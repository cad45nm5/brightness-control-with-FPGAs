...
HD_PWD='G:/deverlopboard/a35t_code/hdmi1_tx_35t_1080p60hz/08_hdmi_tx.runs/impl_3'
cd "$HD_PWD"
...
EAStep vivado -log HDMI_tx_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HDMI_tx_test.tcl -notrace
