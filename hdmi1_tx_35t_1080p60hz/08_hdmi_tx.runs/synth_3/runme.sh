...
HD_PWD='G:/deverlopboard/a35t_code/hdmi1_tx_35t_1080p60hz/08_hdmi_tx.runs/synth_3'
cd "$HD_PWD"
...
EAStep vivado -log HDMI_tx_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HDMI_tx_test.tcl
